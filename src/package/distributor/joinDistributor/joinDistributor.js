...
export default class JoinDistributor extends Component {
  config = {
    navigationBarTextStyle: 'black',
    navigationBarTitleText: '加入合伙人',
    backgroundTextStyle: 'dark',
  ...
  render() {
    ...
    const partnerRightsKeys = Object.keys(PARTNER_RIGHTS)
    console.log(partnerRightsKeys, "partnerRightsKeys")
    return (
      <View
        scrollY
        className="flex-col join-wrap"
      >
        <View className="flex1 join-inwrap">
          ...
          <View className="content-wrap">
            <Block>
              <View className="buy-title">◆ 购买套餐立刻成为合伙人 ◆</View>
              <View className="goods-list">
